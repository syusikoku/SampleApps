...
import com.zy.jet.notebook.ui.adapter.ImgListAdapter2
import com.zy.jet.notebook.ui.weight.layoutmanager.AutoGridLayoutManager
 ...
 * 加载Gank api Girls列表
 */
class GankGirlsFragment2 : BaseDataBindingFragment<FragmentRemotedatasBinding>() {
    private lateinit var imgListAdapter: ImgListAdapter2
    ...
    override fun initView() {
        ...
        recyclerView.layoutManager = AutoGridLayoutManager(BaseFragment.mCtx, 2)
