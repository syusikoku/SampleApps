...
/// 电影列表界面
class BlocFilmListPage extends StatefulWidget {
  final String pageFlag;

  const BlocFilmListPage(this.pageFlag, {Key? key}) : super(key: key);

  @override
  _BlocFilmListPageState createState() => _BlocFilmListPageState();
}

class _BlocFilmListPageState extends State<BlocFilmListPage> {
