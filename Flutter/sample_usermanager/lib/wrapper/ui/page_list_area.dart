...
/// 基于bloc进行数据回传
class PageListPhoneNumber extends StatelessWidget {
  UserInfoVerifyBloc userVeryBloc;

  PageListPhoneNumber(this.userVeryBloc, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _PageListPhoneNumber(userVeryBloc),
    );
  }
}

class _PageListPhoneNumber extends StatefulWidget {
  UserInfoVerifyBloc userVeryBloc;

  _PageListPhoneNumber(this.userVeryBloc, {Key? key}) : super(key: key);

  @override
  _PageListPhoneNumberState createState() =>
      _PageListPhoneNumberState(userVeryBloc);
}

class _PageListPhoneNumberState extends State<_PageListPhoneNumber> {
  ...
  _PageListPhoneNumberState(this.userVeryBloc);
  ...
  buildListItem(BuildContext context, String phone, String country, int index,
    ...
    return Container(
      child: ListTile(
        ...
        onTap: () {
          userVeryBloc.updateAdressContent("$phone");
